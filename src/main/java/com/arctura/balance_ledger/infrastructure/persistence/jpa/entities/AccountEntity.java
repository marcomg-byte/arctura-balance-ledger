 ...
 * domain services. Mapping to and from {@link com.arctura.balance_ledger.domain.account.Account}
 * is handled by {@link com.arctura.balance_ledger.infrastructure.persistence.jpa.mappers.AccountMapper}.</p>
 */
@Entity
@Table(name = "accounts")
